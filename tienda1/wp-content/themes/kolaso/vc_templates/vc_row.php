...
if($enable_overlay) {
	$wrapper_attributes[] = 'style="background-color: ' . $overlay_color . ';"';
    $additional_tag .= '<div class="kolaso_row_overlay" style="background-color: ' . $overlay_color . ';"></div>';
}
...
$output .= '<div class="zy-vc-wrapper">';
$output .= wpb_js_remove_wpautop( $content );
$output .= '</div>';
$output .= '</div>';
$output .= $after_output;

echo kolaso_sanitize_output($output);
